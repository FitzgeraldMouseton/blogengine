...
(2, 1, 'ACCEPTED', 'Нравы Растеряевой улицы', '2020-04-01 00:00:01', 'В городе Т. существует Растеряева улица. Принадлежа к числу захолустий', 10, 3, 2),
...
(5, 1, 'ACCEPTED', 'Замок', '2020-04-06 00:00:01', 'К. прибыл  поздно вечером. Деревня  тонула  в  глубоком снегу. Замковой
...
который вел с проезжей дороги в Деревню, и смотрел в кажущуюся пустоту.', 50, 3, 5),
...
(13, 1, 'ACCEPTED', 'Мудрая кровь', '2019-03-13 00:00:01', 'Хейзел Моутс сидел на зеленом плюше диванчика купе', 12, 3, 4),
(14, 1, 'ACCEPTED', 'Генерал в своем лабиринте', '2020-03-14 00:00:01', 'Хосе Паласиос, самый старый из его слуг', 26, 3, 3),
(15, 1, 'ACCEPTED', 'Будка', '2018-03-15 00:00:01', ' На углу двух весьма глухих и бедных переулков уездного города', 31, 3, 2),
...
(19, 1, 'ACCEPTED', 'Сон', '2020-03-19 00:00:01', 'Был отличный день, и ему захотелось погулять. Но он и двух шагов не прошел, как сразу же очутился на кладбище. По всей территории кладбища зигзагами разбегались дорожки, искусно проложенные, но несообразно извилистые.', 41, 3, 5),
